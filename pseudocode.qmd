...
```{r}
# Run the simulation for 5 games and print the summary results- I like this b/c I can change the number of games
simulation_results <- run_craps_simulation(5)
...
![view updated craps flowcart](updated Craps.png)
